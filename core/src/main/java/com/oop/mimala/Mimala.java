...
public class Mimala extends ApplicationAdapter {
    ...
    public void render() {
        ...
        Rectangle playerRect = new Rectangle(playerCharacter.getX(), playerCharacter.getY(), playerCharacter.getWidth(), playerCharacter.getHeight());
        boolean isOnGround = backgroundStage.checkCollision(playerRect);
        input.setOnGround(isOnGround);
        ...
        backgroundStage.render(batch, cameraController.getCamera().position.x);
